...
import { EMAIL_CHANGED, PASSWORD_CHANGED, LOGIN_USER_SUCCESS, CREATE_USER_SUCCESS, ERROR_FOUND, CLEAR_ERROR, ALREADY_SIGNED } from './types';
...
export const alreadySigned = (user) => {
    return {
        type: ALREADY_SIGNED,
        payload: user
    }
